...
Die VLAN-Struktur trennt die Benutzergruppen am Hauptstandort logisch voneinander. Dadurch koennen Lehrpersonen, Schueler, Administration, Server und WLAN/Gastzugang getrennt verwaltet und mit passenden Sicherheitsregeln versehen werden.

## VLANs am Hauptstandort

| VLAN | Name / Bereich | Netz | Geraete | Zweck |
| --- | --- | --- | --- | --- |
| VLAN 10 | Lehrer | `192.168.10.0/24` | `PC-LEHRER-01`, `PC-LEHRER-02` | Arbeitsnetz fuer Lehrpersonen |
| VLAN 20 | Schueler | `192.168.20.0/24` | `PC-SCHUELER-01` | Arbeitsnetz fuer Schuelergeraete |
| VLAN 30 | WLAN/Gast | nicht im Diagramm angegeben | `AP-GUEST-01` | WLAN- oder Gastzugang, getrennt von internen Bereichen |
| VLAN 40 | Administration | `192.168.40.0/24` | `PC-ADMIN-01` | Administratives Netz fuer Verwaltung und Administration |
...
`SW-CORE-01` verbindet die Endgeraete am Hauptstandort. Die im Diagramm beschrifteten VLAN-Leitungen zeigen, dass unterschiedliche Ports oder Portgruppen verschiedenen VLANs zugeordnet sind. Die Verbindung zum Router dient als Uplink fuer die Weiterleitung zwischen den Netzen und zum WAN.
