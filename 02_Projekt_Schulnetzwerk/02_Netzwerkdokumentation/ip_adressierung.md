...
Das Netzwerk verwendet getrennte IPv4-Netze für die Standorte und Benutzergruppen. Der Hauptstandort arbeitet mit mehreren `192.168.x.0/24`-Netzen. Die Aussenstelle verwendet das Netz `10.10.0.0/24`. Die WAN-Verbindungen zwischen den Routern und dem simulierten Internet sind mit `200.169.x.x` adressiert.

## WAN-Adressen

| Gerät | Interface | IP-Adresse | Netz | Beschreibung |
| --- | --- | --- | --- | --- |
...
| `PC-SCHUELER-01` | `Fa0` | `192.168.20.10` | `192.168.20.0/24` | Schüler-Client |
...
| `PC-SCHUELER-03` | `Fa0` | `10.10.0.11` | `10.10.0.0/24` | Schüler-PC |
...
| `192.168.20.0/24` | nicht im Diagramm angegeben | Schüler-Netz am Hauptstandort |
...
Im Diagramm ist nur `192.168.0.1` als Gateway des Hauptstandorts sichtbar. Für die VLAN-Netze `192.168.10.0/24`, `192.168.20.0/24` und `192.168.40.0/24` sind die Gateway-Adressen im Bild nicht angegeben. Bei einer vollständigen Router-on-a-Stick- oder Layer-3-Konfiguration würden diese Netze jeweils ein eigenes Gateway benötigen.
